...
def yearcheck():
    ...
    with open('testdocs/niterun/yearstore.night','rb') as ys:
    ...
    if int(yearstore) == yearint:
        ...
        with open(f'testdocs\\niterun\\yearstore.night',mode='w')as n:
            n.write(f'{yearint}')  
            # print('files created!')
            
        yearstorefile= 'testdocs/niterun/yearstore.night'
...
def everytwocheck():   
    ...
    with open('testdocs/niterun/sickrun.night','rb') as ys:
    ...
    if int(sickrun) == 12:
        newsick = 2
        with open(f'testdocs\\niterun\\sickrun.night',mode='w')as s:
            s.write(f'{newsick}')  
            print('files created!')
            
        sickrunfile = 'testdocs/niterun/sickrun.night'
...
def EmployeeCreate(nlist,nmlist):
    for x in range(len(nlist)):
        ...
        empnoyears = yearint - (int(nmlist[z][11]))
